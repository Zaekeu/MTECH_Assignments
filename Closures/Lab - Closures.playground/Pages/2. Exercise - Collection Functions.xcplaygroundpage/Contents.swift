...
forwards(name1: "Test", name2: "Name")
...
let familyNames = ["Tyler", "Jodi", "Trini", "Lizzie", "Troy"]

var sortedCollection1 = familyNames.sorted(by: forwards(name1:name2:))
...
var sortedCollection2 = familyNames.sorted { (name1: String, name2: String) -> Bool in
    return name1 < name2
}
...
var sortedCollection3 = familyNames.sorted { return $0 < $1 }
